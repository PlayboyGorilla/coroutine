...
The project provides a means to write light-weight tasks without creating multiple threads, by letting different tasks runing in the context of the same thread. The benefits are
...
4. Cross-platform support and unified programming interface for different platforms, currently including Windows, Mac OS X, Linux, iOS and Android
...
Edit os.mk to make 'OS' either ***osx***, ***linux*** or ***win***, depending on the system you are working with.
